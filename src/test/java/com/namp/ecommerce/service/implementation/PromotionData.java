...
public class PromotionData {
        ...
        private static Timestamp dateTimeStart1 = Timestamp.valueOf("2026-05-10 08:30:00");
        private static Timestamp dateTimeEnd1 = Timestamp.valueOf("2026-12-30 08:30:00");
        ...
        public final static List<PromotionWithProductsDTO> PROMOTIONSWITHPRODUCTSDTO = Arrays.asList(
                        new PromotionWithProductsDTO(1L, "Promocion 1", 50, dateTimeStart1, dateTimeEnd1,
                                        new ArrayList<>()),
                        new PromotionWithProductsDTO(2L, "Promocion 2", 50, dateTimeStart2, dateTimeEnd2,
                                        new ArrayList<>()));
}
